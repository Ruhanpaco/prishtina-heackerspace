      ...
      <div className="relative z-10 w-full max-w-[480px] group">
        ...
        <div className="relative flex flex-col items-center bg-[#1D1D1B] border border-white/10 rounded-[2rem] p-8 sm:p-12 shadow-2xl overflow-hidden">
          ...
          <form className="w-full space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 py-4.5 px-6 bg-brand-yellow hover:bg-brand-yellow/90 text-brand-dark font-black rounded-2xl shadow-xl shadow-brand-yellow/5 transform transition-all active:scale-[0.98] group uppercase tracking-[4px] text-[11px] mt-4"
            >
              Enter Hub
